...
<h2 class="subtitle" id="when">When: Fortnightly</h2>
<h2 class="subtitle" id="where">Where: Chapel</h2>
<p>
  Involvement in Chapel services: candles, readings, prayer, videos, set up and
  pack down. Service in the (school) community
</p>
<br />
...
<h2 class="subtitle" id="leader" style=" color: hsl(48, 100%, 67%); ">
  Leaders: Camille Perilini, Elisah Vili-Umaga and Rev. Nicol
</h2>
<a href="/stageAngels">
